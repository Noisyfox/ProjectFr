...
class config:
    ...
    users = [
        ...
        (1, 'aaa_', sha1('aaa'), 1, 1, 'img/a.jpg', 'UA', 'JS', 1),
        (2, 'bbb_', sha1('bbb'), 2, 1, 'img/b.jpg', 'UA', 'JS', 2),
        (3, 'ccc_', sha1('ccc'), 1, 1, 'img/c.jpg', 'UA', 'SH', 3),
        (4, 'ddd_', sha1('ddd'), 2, 1, 'img/d.jpg', 'UB', 'SH', 4),
        (5, 'eee_', sha1('eee'), 1, 0, 'img/a.jpg', 'UA', 'JS', 0),
        (6, 'fff_', sha1('fff'), 0, 0, 'img/b.jpg', 'UA', 'SH', 0),
        (7, 'ggg_', sha1('ggg'), 1, 0, 'img/c.jpg', 'UB', 'JS', 0),
        (8, 'hhh_', sha1('hhh'), 2, 0, 'img/d.jpg', 'UB', 'SH', 0)
    ]
